    ...
    card.innerHTML = `
      ...
      <div class="space-y-5">
        ...
        <div class="text-center py-5">
          <button class="bg-green-500 hover:bg-lime-300 transition-all duration-200 text-white py-3 px-7 rounded-full font-bold uppercase items-center text-xs cursor-pointer">
